      ...
      >
        ...
        <SwiperSlide>
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #516095d6, #363e45ff)",
            }}
          >
            <div className="col-md-6 text-center ">
              <h5 className="text-light">Best Deal Online on smart watches</h5>
              <h1 className="fw-bold">SMART WEARABLE</h1>
        ...
        <SwiperSlide>
          <div
            className="hero-slide-card row align-items-center text-white shadow-lg  p-5"
            style={{
              background: "linear-gradient(135deg, #3a3737ac, #a37c67ef)",
            }}
          >
            <div className="col-md-6 text-center ">
              <h5 className="text-light">New Collection</h5>
              <h1 className="fw-bold">TRENDING SMARTPHONES</h1>
        ...
        <SwiperSlide>
          <div
            className="hero-slide-card row align-items-center text-white shadow-lg p-5"
            style={{
              background: "linear-gradient(135deg, #28a796ff, #23b18d63)",
            }}
          >
            <div className="col-md-6 text-center">
              <h5 className="text-light">Fresh & Organic</h5>
              <h1 className="fw-bold">PREMIUM FRUITS COLLECTION</h1>
              <p className="text-light fs-3">UP TO 50% OFF</p>
        ...
        <SwiperSlide>
          <div
            className="hero-slide-card row align-items-center text-white shadow-lg p-4 "
            style={{
              background: "linear-gradient(135deg, #e83e8d7e, #a75f2db9)",
            }}
          >
            <div className="col-md-6 text-center ">
